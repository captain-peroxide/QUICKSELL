...
# local imports
from models.llms import OllamaModel,HFModel
...
with gr.Blocks() as demo:
    with gr.Row():
        with gr.Column(scale=1):
            ...
            model_type = gr.Radio(label="Model Source", value="Ollama", choices=["Ollama", "HuggingFace"])
